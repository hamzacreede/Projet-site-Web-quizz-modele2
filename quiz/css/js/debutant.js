...
function last(){
    ...
    if(localStorage.getItem('Score-Css') != null) alert("votre dernier score : "+localStorage.getItem('Score-Css')) ;
}
 ...
 function checkResponse(){
  ...
  var TrueResponse=Array('4','1','1','4','3')   , score=0  , j =0 ;
...
function checkLevel(){
  ...
  var score = localStorage.getItem('Score-Css') ; 
