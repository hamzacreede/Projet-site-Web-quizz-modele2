 ...
 function last(){
  ...
  if(localStorage.getItem('Score-php') != null) alert("votre dernier score : "+localStorage.getItem('Score-php')) ;
}
...
var TrueResponse=Array('3','1','2','2','3')   , score=0  , j =0 ;
...
for(var k =1 ; k<=5;k++){
   ...
   if( UserResponse != '' && TrueResponse[k-1] == UserResponse.value ) score ++ ; 
      ...
      document.getElementById("ShowScore").innerHTML = 
       ...
       localStorage.setItem("Score-php", score);
...
var score = localStorage.getItem('Score-php') ; 
